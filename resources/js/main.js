...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function fitText_default(Alpine2) {
    Alpine2.directive("fit-text", (el, { expression }, { effect: effect3, evaluateLater: evaluateLater2 }) => {
  ...
  async function loadModule(modulePath, card, utils) {
    try {
  ...
  var applyOnChange, TYPES_TO_TAGS, addSelectOptions, makeFormInput;
  var init_formBuilder = __esm({
    "src/formBuilder.js"() {
      applyOnChange = function(field, input) {
      ...
      addSelectOptions = function(select, field) {
  ...
  var require_main = __commonJS({
    "src/main.js"() {
      ...
      var buildCard = async function(template) {
        const dom = document.createElement("div");
        dom.className = "card-container";
        const card = module_default.reactive({
          fields: [],
          addField(field) {

            ...
            <div class="modal-body">
                ...
                <div class="editor-container">
                    <div class="crop-container">
                        <img :src="value.imageUrl" :width="value.width + 'px'" :height="value.height + 'px'" />
                        <div class="crop-box" data-mode="move">
                            <div class="edge vertical" style="top: -4px" data-mode="resize-top">
                                <div></div>
                            </div>
                            <div class="edge vertical" style="bottom: -3px" data-mode="resize-bottom">
                                <div></div>
                            </div>
                            <div class="edge horizontal" style="left: -4px" data-mode="resize-left">
                                <div></div>
                            </div>
                            <div class="edge horizontal" style="right: -3px" data-mode="resize-right">
                                <div></div>
                            </div>
                            <div class="corner"
                    ...
                    <div class="info-container">
                        ...
                        <div class="crop-info">
                            ...
                            <span>, x+</span>
                            <cm-inline-input data-crop-key="xOffset" :value="realCrop.xOffset"></cm-inline-input>
                            <span>&nbsp;y+</span>
                            <cm-inline-input data-crop-key="yOffset" :value="realCrop.yOffset"></cm-inline-input>
                        </div>
                    </div>
                </div>
            </div>
